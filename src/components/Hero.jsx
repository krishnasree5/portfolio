...
export default function Hero() {
  return (
    ...
    >
      <div className="container mx-auto text-center pt-32 pb-20 px-6">
        <div className="bg-white/10 p-1 rounded-full w-32 h-32 mx-auto mb-8 backdrop-blur-sm">
          <img
            src={profile.image}
            alt="Profile"
        ...
        <p className="text-xl mb-8">{profile.role}</p>
